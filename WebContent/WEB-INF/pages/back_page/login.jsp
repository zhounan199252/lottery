...
<script type="text/javascript">
	 ...
	 */
	function submitForm() {
		var passowrdEnc = strEnc($("#txt_passwordForLogin").val(), "${sessionScope.firstKey}", "${sessionScope.secondKey}", "${sessionScope.thirdKey}");
				...
				<div class="form">
						...
						<div class="form-group">
							<div class="col-xs-12  ">
								<div class="input-group">
									<span class="input-group-addon"><span class="glyphicon glyphicon-user"></span></span> <input type="text" id="txt_username" name="username" class="form-control" placeholder="用户名" style="height: 40px" /> <span></span>
								</div>
							</div>
						</div>
						<div class="form-group">
							<div class="col-xs-12  ">
								<div class="input-group">
									<span class="input-group-addon"><span class="glyphicon glyphicon-lock"></span></span> <input type="password" id="txt_passwordForLogin" name="passwordForLogin" class="form-control" placeholder="密码" style="height: 40px" /> <input type="hidden" id="txt_password" name="password" /> <span></span>
								</div>
							</div>
						</div>
						<div class="form-group">
							<div class="col-xs-12  ">
								<div class="input-group">
									<span class="input-group-addon"><span class="glyphicon glyphicon-lock"></span></span> <input type="text" name="code" class="form-control" placeholder="验证码" style="width: 140px; height: 40px" /> <span></span> <span style="padding: 10px 0 0 8px"> <img src="${pageContext.request.contextPath }/cfb.url" id="img_code" onclick="changeValidateCode(this)" title="点击图片刷新验证码" style="width: 80px; height: 36px" />
									</span>
								</div>
							</div>
						</div>
					...
					<div class="form-group form-actions">
						<div class="col-xs-4 col-xs-offset-4 ">
							<button type="submit" class="btn btn-sm btn-info" onclick="$('#form_login').submit();" id="btn_login">
