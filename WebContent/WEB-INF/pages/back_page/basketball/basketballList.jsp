...
<body>
	...
	<div class="container" style="padding: 20px 0 0 30px; width: 100%">
		<div class="row" style="width: 100%;">
			<s:form action="footballBet!listBasketballBet.action" method="post" id="form_search" cssClass="form-horizontal">
				<div class="row" style="width: 100%">
	...
	<div class="container" style="width: 100%; padding-left: 8px">
		<div class="row" style="width: 100%;">
			<div class="row" style="padding: 10px 0 0 10px;">
				...
				<%-- 	<label class="control-label">
						<button class="button" onclick="doFulfil('${pageContext.request.contextPath}/footballBet!doFulfilForBasketball.action')">单关兑奖</button>
					</label> 
					<label class="control-label">
						<button class="button" id="fulfilSeries">串号兑奖</button>
					</label>  --%>
					<label class="control-label">
						<button class="button" onclick="doRemove('${pageContext.request.contextPath}/footballBet!deleteBasketballBet.action')">删除</button>
					</label> <label class="control-label">
				...
				success : function(res) {
					...
					if("false" == data.success) {
						...
						BUI.Message.Confirm("您选择的串号为 " + seriesNum + " 投注项的总兑奖金额为：" + data.bonus + " 元！确定要进行兑奖操作吗？", function() {
							...
							location.href = "${pageContext.request.contextPath}/footballBet!fulfilBySeriesNumForBasketball.action?seriesNum=" + seriesNum;
						}, 'question');
