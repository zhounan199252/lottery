...
<h3><a class="color1" href="${pageContext.request.contextPath}/tore.url?id=${sessionScope.frontCurrentLoginUser.id}">http://localhost:8093/lottery?id=${sessionScope.frontCurrentLoginUser.id}</a></h3>
</div>
