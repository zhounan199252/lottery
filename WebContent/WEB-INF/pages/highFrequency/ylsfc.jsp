...
//获取当前21选5期数	
 function getNowPeroid() {
     ...
     if (strDate >= 0 && strDate <= 9) {
      ...
      var peroid="";
        if(hour>=10){
         peroid = parseInt(12+(hour-10)*6+minute/10);
        }else if(hour<2){
         peroid = parseInt((hour-0)*6+minute/10);
 ...
 //判断选号是否正确
  function checkLengh() {
	  ...
	  var check=$("[name=betChildTypeR]:checked");
		...
		if(betChildType=="x5"){
			 for(var i=1;i<=5;i++){
				  if( $("#select"+i+"ylsfc").children(".checked").length!=1){
						return false; 
				  }
	  	    	  $("#select"+i+"ylsfc").children(".checked").each(function (index, domEle) { 
		                    var num= $(domEle).text(); 
		                      betNum =betNum+i+","+num+",";
		   			   });
	  	           }
		 ...
		 if( betChildType=="x4q4"){
			 ...
			 $("#select5ylsfc").children(".checked").each(function (index, domEle) { 
                 var num= $(domEle).text(); 
                   betNum =betNum+num+",";
			   });  	  
 ...
 function buy() {
	          ...
	          $.ajax({
	  			...
	  			data:{
	  				...
	  				"betType":betType,
	  				"betPerson":betPerson,
	  				"betChildType":"ylsfc-"+betChildType
 ...
 //查看开奖信息
	...
	function timeCountCqssc() {	
	     ...
	     if(hour>=10){
	      ...
	      if(timeLimate()==false){
	  	    ...
	  	    $('#div2ylsfc').text("第"+peroid+"正在销售中"); 
	  	    $('#div3ylsfc').text("截止销售时间："+date.Format("yyyy-MM-dd hh:mm:ss"));
	...
	var second=Math.floor(leftsecond-day1*24*60*60-hour*3600-minute*60); 
	  $('#div4ylsfc').text("距开奖时间还有："+day1+"天"+hour+"小时"+minute+"分"+second+"秒");  
	} 
	...
	function show(type){
		...
		$("#select1dxd").hide();
	   if(type==5){
			$("#select5ylsfcspan").show();
			$("#select5ylsfc").show();
			$("#select4ylsfc").show();
			$("#select3ylsfc").show();
			$("#select2ylsfc").show();
			$("#select1ylsfc").show(); 
			$("#select1ylsfc").nextAll("br").show(); 
		}else if(type=='q4'){
			$("#select5ylsfc").hide();
			$("#select4ylsfc").show();
			$("#select3ylsfc").show();
			...
			$("#select2ylsfc").show();
			$("#select1ylsfc").hide(); 
			$("#select2ylsfc").prevAll("br").hide(); 
			$("#select2ylsfc").nextAll("br").show(); 
		} else if(type=='q3'){
			$("#select5ylsfc").hide();
			$("#select4ylsfc").hide();
			$("#select3ylsfc").show();
			...
			$("#select2ylsfc").hide();
			$("#select1ylsfc").hide();
			$("#select3ylsfc").prevAll("br").hide(); 
			$("#select3ylsfc").nextAll("br").show(); 
		} else if(type=='q2'){
			$("#select5ylsfc").hide();
			$("#select4ylsfc").hide();
			$("#select3ylsfc").hide();
			...
			$("#select2ylsfc").hide();
			$("#select1ylsfc").hide(); 
			$("#select4ylsfc").prevAll("br").hide(); 
			$("#select4ylsfc").nextAll("br").show(); 
		} else if(type=='q2dxd'){
			$("#select5ylsfc").hide();
			$("#select4ylsfc").hide();
			$("#select3ylsfc").hide(); 
			...
			$("#select5ylsfcspan").hide();
			$("#select5ylsfc").show();
			$("#select4ylsfc").hide();
			$("#select3ylsfc").hide(); 
			$("#select2ylsfc").hide(); 
			$("#select1ylsfc").hide(); 
			$("#select5ylsfc").prevAll("br").hide(); 
			$("#select5ylsfc").nextAll("br").show(); 
		} 
		}
...
<body style="background: #FFC">
	...
	<div align="center" id="main" style="height: 100%; overflow: auto;">
			...
			<li class="active"><a href="ylsfc.url">永乐十分彩</a></li>
			<li><a href="bjpk.url">北京pk10</a></li>
		</ul>
		<div id="divylsfc" style="width: 1086px;" align="left">
			<div class="panel panel panel-info" style="width: 50%; float: right; height: 200px; background: #FFC">
				...
				<div class="panel-body" id="div1ylsfc"></div>
			</div>
			<div class="panel panel panel-info" style="width: 50%; float: right; height: 200px; background: #FFC">
				<div class="panel-heading" id="div2ylsfc"></div>
				<div class="panel-body" id="div3ylsfc"></div>
				<div class="panel-body" id="div4ylsfc"></div>
			</div>
				...
				<div class="panel-body">
					...
					<div class="well well-lg" style="background: #FFC">
						...
						<div style="height: 130px">
							...
							<div id='select1ylsfc' class="span_style" >
							...
							<br>
							<div id='select2ylsfc' class="span_style" >
								<span class="span_style">千位:</span> <span onclick='check(this)' class="span_cicle">0</span> <span onclick='check(this)' class="span_cicle">1</span> <span onclick='check(this)' class="span_cicle">2</span> <span onclick='check(this)' class="span_cicle">3</span> <span onclick='check(this)' class="span_cicle">4</span> <span onclick='check(this)' class="span_cicle">5</span> <span onclick='check(this)' class="span_cicle">6</span> <span onclick='check(this)' class="span_cicle">7</span> <span onclick='check(this)' class="span_cicle">8</span> <span onclick='check(this)' class="span_cicle">9</span>
							</div>
							<br>
							<div id='select3ylsfc' class="span_style" >
								<span class="span_style">百位:</span> <span onclick='check(this)' class="span_cicle">0</span> <span onclick='check(this)' class="span_cicle">1</span> <span onclick='check(this)' class="span_cicle">2</span> <span onclick='check(this)' class="span_cicle">3</span> <span onclick='check(this)' class="span_cicle">4</span> <span onclick='check(this)' class="span_cicle">5</span> <span onclick='check(this)' class="span_cicle">6</span> <span onclick='check(this)' class="span_cicle">7</span> <span onclick='check(this)' class="span_cicle">8</span> <span onclick='check(this)' class="span_cicle">9</span>
							</div>
							<br>
							<div id='select4ylsfc' class="span_style" >
								<span class="span_style">十位:</span> <span onclick='check(this)' class="span_cicle">0</span> <span onclick='check(this)' class="span_cicle">1</span> <span onclick='check(this)' class="span_cicle">2</span> <span onclick='check(this)' class="span_cicle">3</span> <span onclick='check(this)' class="span_cicle">4</span> <span onclick='check(this)' class="span_cicle">5</span> <span onclick='check(this)' class="span_cicle">6</span> <span onclick='check(this)' class="span_cicle">7</span> <span onclick='check(this)' class="span_cicle">8</span> <span onclick='check(this)' class="span_cicle">9</span>
							</div>
							<br>
							<div id='select5ylsfc' class="span_style" >
								<span id='select5ylsfcspan'   class="span_style">个位:</span> <span onclick='check(this)' class="span_cicle">0</span> <span onclick='check(this)' class="span_cicle">1</span> <span onclick='check(this)' class="span_cicle">2</span> <span onclick='check(this)' class="span_cicle">3</span> <span onclick='check(this)' class="span_cicle">4</span> <span onclick='check(this)' class="span_cicle">5</span> <span onclick='check(this)' class="span_cicle">6</span> <span onclick='check(this)' class="span_cicle">7</span> <span onclick='check(this)' class="span_cicle">8</span> <span onclick='check(this)' class="span_cicle">9</span>
							</div>
							   <br>
