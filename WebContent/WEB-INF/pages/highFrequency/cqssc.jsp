 ...
 //判断选号是否正确
  function checkLengh() {
	  ...
	  var  type=  betChildType.substring(0, 1); 
		...
		if(betChildType=="x2z"||betChildType=="x3z3"||betChildType=="x3z6"){
			if(betChildType=="x3z3"){
				num4=2;	
			}
			 var num1=$("#select5cqssc").children(".checked").length;
			  if(num1!=num4){
					return false;
					} 
			  			  
		}else{
			 for(var i=5-num4+1;i<=5;i++){
		...
		<div id="divcqssc" style="width: 1086px;" align="left">
			...
			<div class="panel panel panel-info" style="width: 100%; height: 700px; background: #FFC">
				...
				<div class="panel-body">
				    ...
				    <label onclick="show(2)" ><input name="betChildType" type="radio" value="x2" />二星直选 </label>
				    <label onclick="show(0)" ><input name="betChildType" type="radio" value="x2z" />二星组选</label>
				    <label onclick="show(3)" ><input name="betChildType" type="radio" value="x3" />三星直选</label>
				    <label onclick="show(0)" ><input name="betChildType" type="radio" value="x3z3" />三星组三 </label>
				    <label onclick="show(0)" ><input name="betChildType" type="radio" value="x3z6" />三星组六 </label>
				    <label onclick="show(5)" ><input name="betChildType" type="radio" value="x5" />五星直选 </label>
					</div>
					
					<div class="well well-lg" style="background: #FFC">
						<div style='margin-bottom: 5px;'>选号区:</div>
						<div style="height: 130px">
							<div id='select1cqssc' class="span_style" style="display:none">
