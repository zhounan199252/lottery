...
//	            }
				...
				}else if(childType.equals("dd")||childType.equals("pk10dd")){
					int num =0;
					 for(int i=0;i<betn.length/2;i++){
				...
				}else if(childType.equals("x5")||childType.equals("x4q4")||childType.equals("x4h4")||childType.equals("x4r4")||
						childType.equals("x3q3")||childType.equals("x3z3")||childType.equals("x3h3")||childType.equals("x3r3")||
						childType.equals("x2q2")||childType.equals("x2h2")||childType.equals("x2r2")||childType.equals("pk10q2")||childType.equals("pk10q3")){
				    for(int i=0;i<betn.length/2;i++){
				    	if(open[Integer.valueOf(betn[2*i])-1].equals(betn[2*i+1])){
				    		  flag = true;	
				    	}else{
				...
				}else if(childType.equals("q2dxd")||childType.equals("h2dxd")||childType.equals("r2dxd")){		  
				    for(int i=0;i<betn.length/2;i++){
				...
				}else if(childType.equals("wwdxd")||childType.equals("qwdxd")||childType.equals("bwdxd")
